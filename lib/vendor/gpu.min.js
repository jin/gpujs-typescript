GPU = function () {
    var parser = function () {
        function createSourceLocation(source, firstToken, lastToken) { return new SourceLocation(source, new Position(firstToken.first_line, firstToken.first_column), new Position(lastToken.last_line, lastToken.last_column)); }
        function parseRegularExpressionLiteral(literal) { var last = literal.lastIndexOf("/"), body = literal.substring(1, last), flags = literal.substring(last + 1); return new RegExp(body, flags); }
        function parseNumericLiteral(literal) { return "0" === literal.charAt(0) ? "x" === literal.charAt(1).toLowerCase() ? parseInt(literal, 16) : "." === literal.charAt(1) ? parseFloat(literal) : parseInt(literal, 8) : Number(literal); }
        function ProgramNode(body, loc) { this.type = "Program", this.body = body, this.loc = loc; }
        function EmptyStatementNode(loc) { this.type = "EmptyStatement", this.loc = loc; }
        function BlockStatementNode(body, loc) { this.type = "BlockStatement", this.body = body, this.loc = loc; }
        function ExpressionStatementNode(expression, loc) { this.type = "ExpressionStatement", this.expression = expression, this.loc = loc; }
        function IfStatementNode(test, consequent, alternate, loc) { this.type = "IfStatement", this.test = test, this.consequent = consequent, this.alternate = alternate, this.loc = loc; }
        function LabeledStatementNode(label, body, loc) { this.type = "LabeledStatement", this.label = label, this.body = body, this.loc = loc; }
        function BreakStatementNode(label, loc) { this.type = "BreakStatement", this.label = label, this.loc = loc; }
        function ContinueStatementNode(label, loc) { this.type = "ContinueStatement", this.label = label, this.loc = loc; }
        function WithStatementNode(object, body, loc) { this.type = "WithStatement", this.object = object, this.body = body, this.loc = loc; }
        function SwitchStatementNode(discriminant, cases, loc) { this.type = "SwitchStatement", this.discriminant = discriminant, this.cases = cases, this.loc = loc; }
        function ReturnStatementNode(argument, loc) { this.type = "ReturnStatement", this.argument = argument, this.loc = loc; }
        function ThrowStatementNode(argument, loc) { this.type = "ThrowStatement", this.argument = argument, this.loc = loc; }
        function TryStatementNode(block, handlers, finalizer, loc) { this.type = "TryStatement", this.block = block, this.handlers = handlers, this.finalizer = finalizer, this.loc = loc; }
        function WhileStatementNode(test, body, loc) { this.type = "WhileStatement", this.test = test, this.body = body, this.loc = loc; }
        function DoWhileStatementNode(body, test, loc) { this.type = "DoWhileStatement", this.body = body, this.test = test, this.loc = loc; }
        function ForStatementNode(init, test, update, body, loc) { this.type = "ForStatement", this.init = init, this.test = test, this.update = update, this.body = body, this.loc = loc; }
        function ForInStatementNode(left, right, body, loc) { this.type = "ForInStatement", this.left = left, this.right = right, this.body = body, this.loc = loc; }
        function DebugggerStatementNode(loc) { this.type = "DebuggerStatement", this.loc = loc; }
        function FunctionDeclarationNode(id, params, body, generator, expression, loc) { this.type = "FunctionDeclaration", this.id = id, this.params = params, this.body = body, this.generator = generator, this.expression = expression, this.loc = loc; }
        function VariableDeclarationNode(declarations, kind, loc) { this.type = "VariableDeclaration", this.declarations = declarations, this.kind = kind, this.loc = loc; }
        function VariableDeclaratorNode(id, init, loc) { this.type = "VariableDeclarator", this.id = id, this.init = init, this.loc = loc; }
        function ThisExpressionNode(loc) { this.type = "ThisExpression", this.loc = loc; }
        function ArrayExpressionNode(elements, loc) { this.type = "ArrayExpression", this.elements = elements, this.loc = loc; }
        function ObjectExpressionNode(properties, loc) { this.type = "ObjectExpression", this.properties = properties, this.loc = loc; }
        function FunctionExpressionNode(id, params, body, generator, expression, loc) { this.type = "FunctionExpression", this.id = id, this.params = params, this.body = body, this.generator = generator, this.expression = expression, this.loc = loc; }
        function SequenceExpressionNode(expressions, loc) { this.type = "SequenceExpression", this.expressions = expressions, this.loc = loc; }
        function UnaryExpressionNode(operator, prefix, argument, loc) { this.type = "UnaryExpression", this.operator = operator, this.prefix = prefix, this.argument = argument, this.loc = loc; }
        function BinaryExpressionNode(operator, left, right, loc) { this.type = "BinaryExpression", this.operator = operator, this.left = left, this.right = right, this.loc = loc; }
        function AssignmentExpressionNode(operator, left, right, loc) { this.type = "AssignmentExpression", this.operator = operator, this.left = left, this.right = right, this.loc = loc; }
        function UpdateExpressionNode(operator, argument, prefix, loc) { this.type = "UpdateExpression", this.operator = operator, this.argument = argument, this.prefix = prefix, this.loc = loc; }
        function LogicalExpressionNode(operator, left, right, loc) { this.type = "LogicalExpression", this.operator = operator, this.left = left, this.right = right, this.loc = loc; }
        function ConditionalExpressionNode(test, consequent, alternate, loc) { this.type = "ConditionalExpression", this.test = test, this.consequent = consequent, this.alternate = alternate, this.loc = loc; }
        function NewExpressionNode(callee, args, loc) { this.type = "NewExpression", this.callee = callee, this.arguments = args, this.loc = loc; }
        function CallExpressionNode(callee, args, loc) { this.type = "CallExpression", this.callee = callee, this.arguments = args, this.loc = loc; }
        function MemberExpressionNode(object, property, computed, loc) { this.type = "MemberExpression", this.object = object, this.property = property, this.computed = computed, this.loc = loc; }
        function SwitchCaseNode(test, consequent, loc) { this.type = "SwitchCase", this.test = test, this.consequent = consequent, this.loc = loc; }
        function CatchClauseNode(param, body, loc) { this.type = "CatchClause", this.param = param, this.guard = null, this.body = body, this.loc = loc; }
        function IdentifierNode(name, loc) { this.type = "Identifier", this.name = name, this.loc = loc; }
        function LiteralNode(value, loc) { this.type = "Literal", this.value = value, this.loc = loc; }
        function SourceLocation(source, start, end) { this.source = source, this.start = start, this.end = end; }
        function Position(line, column) { this.line = line, this.column = column; }
        function Parser() { this.yy = {}; }
        var parser = { trace: function () { }, yy: {}, symbols_: { error: 2, Statement: 3, Block: 4, VariableStatement: 5, EmptyStatement: 6, ExpressionStatement: 7, IfStatement: 8, IterationStatement: 9, ContinueStatement: 10, BreakStatement: 11, ReturnStatement: 12, WithStatement: 13, LabelledStatement: 14, SwitchStatement: 15, ThrowStatement: 16, TryStatement: 17, DebuggerStatement: 18, "{": 19, StatementList: 20, "}": 21, VAR: 22, VariableDeclarationList: 23, VariableDeclaration: 24, ",": 25, VariableDeclarationListNoIn: 26, VariableDeclarationNoIn: 27, IDENTIFIER: 28, Initialiser: 29, InitialiserNoIn: 30, "=": 31, AssignmentExpression: 32, AssignmentExpressionNoIn: 33, ";": 34, ExpressionNoBF: 35, IF: 36, "(": 37, Expression: 38, ")": 39, ELSE: 40, DO: 41, WHILE: 42, FOR: 43, ExpressionNoIn: 44, LeftHandSideExpression: 45, IN: 46, CONTINUE: 47, BREAK: 48, RETURN: 49, WITH: 50, SWITCH: 51, CaseBlock: 52, CaseClauses: 53, DefaultClause: 54, CaseClause: 55, CASE: 56, ":": 57, DEFAULT: 58, THROW: 59, TRY: 60, Catch: 61, Finally: 62, CATCH: 63, FINALLY: 64, DEBUGGER: 65, FunctionDeclaration: 66, FUNCTION: 67, FunctionBody: 68, FormalParameterList: 69, FunctionExpression: 70, SourceElements: 71, Program: 72, EOF: 73, SourceElement: 74, PrimaryExpression: 75, PrimaryExpressionNoBrace: 76, ObjectLiteral: 77, THIS: 78, Literal: 79, ArrayLiteral: 80, "[": 81, "]": 82, Elision: 83, ElementList: 84, PropertyNameAndValueList: 85, PropertyAssignment: 86, PropertyName: 87, PropertySetParameterList: 88, IdentifierName: 89, StringLiteral: 90, NumericLiteral: 91, MemberExpression: 92, ".": 93, NEW: 94, Arguments: 95, MemberExpressionNoBF: 96, NewExpression: 97, NewExpressionNoBF: 98, CallExpression: 99, CallExpressionNoBF: 100, ReservedWord: 101, ArgumentList: 102, LeftHandSideExpressionNoBF: 103, PostfixExpression: 104, "++": 105, "--": 106, PostfixExpressionNoBF: 107, UnaryExpression: 108, UnaryExpr: 109, UnaryExpressionNoBF: 110, DELETE: 111, VOID: 112, TYPEOF: 113, "BR++": 114, "BR--": 115, "+": 116, "-": 117, "~": 118, "!": 119, MultiplicativeExpression: 120, "*": 121, "/": 122, "%": 123, MultiplicativeExpressionNoBF: 124, AdditiveExpression: 125, AdditiveExpressionNoBF: 126, ShiftExpression: 127, "<<": 128, ">>": 129, ">>>": 130, ShiftExpressionNoBF: 131, RelationalExpression: 132, "<": 133, ">": 134, "<=": 135, ">=": 136, INSTANCEOF: 137, RelationalExpressionNoIn: 138, RelationalExpressionNoBF: 139, EqualityExpression: 140, "==": 141, "!=": 142, "===": 143, "!==": 144, EqualityExpressionNoIn: 145, EqualityExpressionNoBF: 146, BitwiseANDExpression: 147, "&": 148, BitwiseANDExpressionNoIn: 149, BitwiseANDExpressionNoBF: 150, BitwiseXORExpression: 151, "^": 152, BitwiseXORExpressionNoIn: 153, BitwiseXORExpressionNoBF: 154, BitwiseORExpression: 155, "|": 156, BitwiseORExpressionNoIn: 157, BitwiseORExpressionNoBF: 158, LogicalANDExpression: 159, "&&": 160, LogicalANDExpressionNoIn: 161, LogicalANDExpressionNoBF: 162, LogicalORExpression: 163, "||": 164, LogicalORExpressionNoIn: 165, LogicalORExpressionNoBF: 166, ConditionalExpression: 167, "?": 168, ConditionalExpressionNoIn: 169, ConditionalExpressionNoBF: 170, AssignmentOperator: 171, AssignmentExpressionNoBF: 172, "*=": 173, "/=": 174, "%=": 175, "+=": 176, "-=": 177, "<<=": 178, ">>=": 179, ">>>=": 180, "&=": 181, "^=": 182, "|=": 183, NullLiteral: 184, BooleanLiteral: 185, RegularExpressionLiteral: 186, NULL: 187, TRUE: 188, FALSE: 189, NUMERIC_LITERAL: 190, STRING_LITERAL: 191, RegularExpressionLiteralBegin: 192, REGEXP_LITERAL: 193, CLASS: 194, CONST: 195, ENUM: 196, EXPORT: 197, EXTENDS: 198, IMPORT: 199, SUPER: 200, $accept: 0, $end: 1 }, terminals_: { 2: "error", 19: "{", 21: "}", 22: "VAR", 25: ",", 28: "IDENTIFIER", 31: "=", 34: ";", 36: "IF", 37: "(", 39: ")", 40: "ELSE", 41: "DO", 42: "WHILE", 43: "FOR", 46: "IN", 47: "CONTINUE", 48: "BREAK", 49: "RETURN", 50: "WITH", 51: "SWITCH", 56: "CASE", 57: ":", 58: "DEFAULT", 59: "THROW", 60: "TRY", 63: "CATCH", 64: "FINALLY", 65: "DEBUGGER", 67: "FUNCTION", 73: "EOF", 78: "THIS", 81: "[", 82: "]", 93: ".", 94: "NEW", 105: "++", 106: "--", 111: "DELETE", 112: "VOID", 113: "TYPEOF", 114: "BR++", 115: "BR--", 116: "+", 117: "-", 118: "~", 119: "!", 121: "*", 122: "/", 123: "%", 128: "<<", 129: ">>", 130: ">>>", 133: "<", 134: ">", 135: "<=", 136: ">=", 137: "INSTANCEOF", 141: "==", 142: "!=", 143: "===", 144: "!==", 148: "&", 152: "^", 156: "|", 160: "&&", 164: "||", 168: "?", 173: "*=", 174: "/=", 175: "%=", 176: "+=", 177: "-=", 178: "<<=", 179: ">>=", 180: ">>>=", 181: "&=", 182: "^=", 183: "|=", 187: "NULL", 188: "TRUE", 189: "FALSE", 190: "NUMERIC_LITERAL", 191: "STRING_LITERAL", 193: "REGEXP_LITERAL", 194: "CLASS", 195: "CONST", 196: "ENUM", 197: "EXPORT", 198: "EXTENDS", 199: "IMPORT", 200: "SUPER" }, productions_: [0, [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [3, 1], [4, 3], [20, 2], [20, 0], [5, 2], [23, 1], [23, 3], [26, 1], [26, 3], [24, 1], [24, 2], [27, 1], [27, 2], [29, 2], [30, 2], [6, 1], [7, 2], [7, 2], [8, 5], [8, 7], [9, 7], [9, 7], [9, 5], [9, 9], [9, 8], [9, 8], [9, 7], [9, 8], [9, 7], [9, 7], [9, 6], [9, 10], [9, 9], [9, 9], [9, 8], [9, 7], [9, 8], [10, 2], [10, 2], [10, 3], [10, 3], [11, 2], [11, 2], [11, 3], [11, 3], [12, 2], [12, 2], [12, 3], [12, 3], [13, 5], [15, 5], [52, 3], [52, 5], [53, 2], [53, 0], [55, 4], [54, 3], [14, 3], [16, 3], [16, 3], [17, 3], [17, 3], [17, 4], [61, 5], [62, 2], [18, 2], [18, 2], [66, 7], [66, 8], [70, 7], [70, 8], [70, 6], [70, 7], [69, 1], [69, 3], [68, 1], [72, 2], [71, 2], [71, 0], [74, 1], [74, 1], [75, 1], [75, 1], [76, 1], [76, 1], [76, 1], [76, 1], [76, 3], [80, 2], [80, 3], [80, 3], [80, 4], [80, 5], [84, 1], [84, 2], [84, 3], [84, 4], [83, 1], [83, 2], [77, 2], [77, 3], [77, 4], [85, 1], [85, 3], [86, 3], [86, 7], [86, 8], [87, 1], [87, 1], [87, 1], [88, 1], [92, 1], [92, 1], [92, 4], [92, 3], [92, 3], [96, 1], [96, 4], [96, 3], [96, 3], [97, 1], [97, 2], [98, 1], [98, 2], [99, 2], [99, 2], [99, 4], [99, 3], [100, 2], [100, 2], [100, 4], [100, 3], [89, 1], [89, 1], [95, 2], [95, 3], [102, 1], [102, 3], [45, 1], [45, 1], [103, 1], [103, 1], [104, 1], [104, 2], [104, 2], [107, 1], [107, 2], [107, 2], [108, 1], [108, 1], [110, 1], [110, 1], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [109, 2], [120, 1], [120, 3], [120, 3], [120, 3], [124, 1], [124, 3], [124, 3], [124, 3], [125, 1], [125, 3], [125, 3], [126, 1], [126, 3], [126, 3], [127, 1], [127, 3], [127, 3], [127, 3], [131, 1], [131, 3], [131, 3], [131, 3], [132, 1], [132, 3], [132, 3], [132, 3], [132, 3], [132, 3], [132, 3], [138, 1], [138, 3], [138, 3], [138, 3], [138, 3], [138, 3], [139, 1], [139, 3], [139, 3], [139, 3], [139, 3], [139, 3], [139, 3], [140, 1], [140, 3], [140, 3], [140, 3], [140, 3], [145, 1], [145, 3], [145, 3], [145, 3], [145, 3], [146, 1], [146, 3], [146, 3], [146, 3], [146, 3], [147, 1], [147, 3], [149, 1], [149, 3], [150, 1], [150, 3], [151, 1], [151, 3], [153, 1], [153, 3], [154, 1], [154, 3], [155, 1], [155, 3], [157, 1], [157, 3], [158, 1], [158, 3], [159, 1], [159, 3], [161, 1], [161, 3], [162, 1], [162, 3], [163, 1], [163, 3], [165, 1], [165, 3], [166, 1], [166, 3], [167, 1], [167, 5], [169, 1], [169, 5], [170, 1], [170, 5], [32, 1], [32, 3], [32, 3], [33, 1], [33, 3], [33, 3], [172, 1], [172, 3], [172, 3], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [171, 1], [38, 1], [38, 3], [44, 1], [44, 3], [35, 1], [35, 3], [79, 1], [79, 1], [79, 1], [79, 1], [79, 1], [184, 1], [185, 1], [185, 1], [91, 1], [90, 1], [186, 2], [192, 1], [192, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1], [101, 1]], performAction: function (yytext, yyleng, yylineno, yy, yystate, $$, _$) {
                var $0 = $$.length - 1;
                switch (yystate) {
                    case 16:
                    ...
                    case 81:
                        ...
                        break;
                    case 82:
                        this.$ = new FunctionDeclarationNode(new IdentifierNode($$[$0 - 5], createSourceLocation(null, _$[$0 - 5], _$[$0 - 5])), [], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 6], _$[$0]));
                        break;
                    case 83:
                        this.$ = new FunctionDeclarationNode(new IdentifierNode($$[$0 - 6], createSourceLocation(null, _$[$0 - 6], _$[$0 - 6])), $$[$0 - 4], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 7], _$[$0]));
                        break;
                    case 84:
                        this.$ = new FunctionExpressionNode(new IdentifierNode($$[$0 - 5], createSourceLocation(null, _$[$0 - 5], _$[$0 - 5])), [], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 6], _$[$0]));
                        break;
                    case 85:
                        this.$ = new FunctionExpressionNode(new IdentifierNode($$[$0 - 6], createSourceLocation(null, _$[$0 - 6], _$[$0 - 6])), $$[$0 - 4], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 7], _$[$0]));
                        break;
                    case 86:
                        this.$ = new FunctionExpressionNode(null, [], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 5], _$[$0]));
                        break;
                    case 87:
                        this.$ = new FunctionExpressionNode(null, $$[$0 - 4], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 6], _$[$0]));
                        break;
                    case 88:
                    ...
                    case 89:
                        ...
                        break;
                    case 91: return this.$ = new ProgramNode($$[$0 - 1], createSourceLocation(null, _$[$0 - 1], _$[$0])), this.$;
                    case 92:
                        this.$ = $$[$0 - 1].concat($$[$0]);
                        break;
                    case 93:
                    ...
                    case 119:
                        ...
                        break;
                    case 120:
                        "get" === $$[$0 - 6] ? this.$ = { key: $$[$0 - 5], value: new FunctionExpressionNode(null, [], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 5], _$[$0])), kind: "get" } : this.parseError("Invalid getter", {});
                        break;
                    case 121:
                        "set" === $$[$0 - 7] ? this.$ = { key: $$[$0 - 6], value: new FunctionExpressionNode(null, $$[$0 - 4], $$[$0 - 1], !1, !1, createSourceLocation(null, _$[$0 - 6], _$[$0])), kind: "set" } : this.parseError("Invalid setter", {});
                        break;
                    case 125:
                        this.$ = [new IdentifierNode($$[$0], createSourceLocation(null, _$[$0], _$[$0]))];
                        break;
                    case 128:
                        this.$ = new MemberExpressionNode($$[$0 - 3], $$[$0 - 1], !0, createSourceLocation(null, _$[$0 - 3], _$[$0]));
                        break;
                    case 129:
                        this.$ = new MemberExpressionNode($$[$0 - 2], $$[$0], !1, createSourceLocation(null, _$[$0 - 2], _$[$0]));
                        break;
                    case 130:
                    ...
                    case 152:
                        ...
                        break;
                    case 158:
                        this.$ = new UpdateExpressionNode("++", $$[$0 - 1], !1, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 159:
                        this.$ = new UpdateExpressionNode("--", $$[$0 - 1], !1, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    ...
                    case 162:
                        ...
                        break;
                    case 167:
                        this.$ = new UnaryExpressionNode("delete", !0, $$[$0], createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 168:
                        this.$ = new UnaryExpressionNode("void", !0, $$[$0], createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 169:
                        this.$ = new UnaryExpressionNode("typeof", !0, $$[$0], createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 170:
                        _$[$0 - 1].first_line = _$[$0 - 1].last_line, _$[$0 - 1].first_column = _$[$0 - 1].last_column - 2, this.$ = new UpdateExpressionNode("++", $$[$0], !0, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 171:
                        _$[$0 - 1].first_line = _$[$0 - 1].last_line, _$[$0 - 1].first_column = _$[$0 - 1].last_column - 2, this.$ = new UpdateExpressionNode("--", $$[$0], !0, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 172:
                        this.$ = new UpdateExpressionNode("++", $$[$0], !0, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 173:
                        this.$ = new UpdateExpressionNode("--", $$[$0], !0, createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 174:
                        this.$ = new UnaryExpressionNode("+", !0, $$[$0], createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    case 175:
                        this.$ = new UnaryExpressionNode("-", !0, $$[$0], createSourceLocation(null, _$[$0 - 1], _$[$0]));
                        break;
                    ...
                    case 279:
                        ...
                        break;
                    case 292:
                        "SequenceExpression" === $$[$0 - 2].type ? ($$[$0 - 2].expressions.concat($$[$0]), $$[$0 - 2].loc = createSourceLocation(null, _$[$0 - 2], _$[$0]), this.$ = $$[$0 - 2]) : this.$ = new SequenceExpressionNode([$$[$0 - 2], $$[$0]], createSourceLocation(null, _$[$0 - 2], _$[$0]));
                        break;
                    case 294:
                        "SequenceExpression" === $$[$0 - 2].type ? ($$[$0 - 2].expressions.concat($$[$0]), $$[$0 - 2].loc = createSourceLocation(null, _$[$0 - 2], _$[$0]), this.$ = $$[$0 - 2]) : this.$ = new SequenceExpressionNode([$$[$0 - 2], $$[$0]], createSourceLocation(null, _$[$0 - 2], _$[$0]));
                        break;
                    ...
                    case 303:
                        ...
                        break;
                    case 304:
                        this.$ = new LiteralNode(!1, createSourceLocation(null, _$[$0], _$[$0]));
                        break;
                    case 305:
                    ...
                    case 308:
                        ...
                        break;
                    case 309: yy.lexer.begin("REGEXP");
                }
                ...
                if (state = stack[stack.length - 1], this.defaultActions[state] ? action = this.defaultActions[state] : (null !== symbol && "undefined" != typeof symbol || (symbol = lex()), action = table[state] && table[state][symbol]), "undefined" == typeof action || !action.length || !action[0]) {
                    ...
                    if (recovering)
                        preErrorSymbol !== EOF && (error_rule_depth = locateNearestErrorRecoveryRule(state));
                    else {
                        error_rule_depth = locateNearestErrorRecoveryRule(state), expected = [];
            ...
            var lexer = { EOF: 1, parseError: function (str, hash) { if (!this.yy.parser)
                    ...
                    if (tempMatch = this._input.match(this.rules[rules[i]]), tempMatch && (!match || tempMatch[0].length > match[0].length)) {
                        if (match = tempMatch, index = i, this.options.backtrack_lexer) {
                            if (token = this.test_match(tempMatch, rules[i]), token !== !1)
                                return token;
                            if (this._backtrack) {
                                match = !1;
                                continue;
                    ...
                    case 5:
                        if (yy_.yytext.match(/\r|\n/) && (parser.newLine = !0), parser.restricted && parser.newLine)
                            return this.unput(yy_.yytext), parser.restricted = !1, ";";
                        break;
                    case 6: return parser.restricted = !1, "STRING_LITERAL";
                    case 7: return parser.restricted = !0, "BREAK";
                    case 8: return "CASE";
                    case 9: return "CATCH";
                    case 10: return parser.restricted = !0, "CONTINUE";
                    ...
                    case 22: return parser.restricted = !1, "NEW";
                    case 23: return parser.restricted = !0, "RETURN";
                    case 24: return "SWITCH";
                    case 25: return parser.restricted = !1, "THIS";
                    case 26: return parser.restricted = !0, "THROW";
                    case 27: return "TRY";
                    case 28: return parser.restricted = !1, "TYPEOF";
                    case 29: return "VAR";
                    case 30: return parser.restricted = !1, "VOID";
                    case 31: return "WHILE";
                    case 32: return "WITH";
                    case 33: return parser.restricted = !1, "TRUE";
                    case 34: return parser.restricted = !1, "FALSE";
                    case 35: return parser.restricted = !1, "NULL";
                    ...
                    case 43: return parser.restricted = !1, "IDENTIFIER";
                    case 44: return parser.restricted = !1, "NUMERIC_LITERAL";
                    case 45: return parser.restricted = !1, "NUMERIC_LITERAL";
                    case 46: return parser.restricted = !1, "NUMERIC_LITERAL";
                    case 47: return parser.restricted = !1, "{";
                    case 48: return "}";
                    case 49: return parser.restricted = !1, "(";
                    case 50: return ")";
                    case 51: return parser.restricted = !1, "[";
                    case 52: return "]";
                    case 53: return ".";
                    case 54: return parser.restricted = !1, ";";
                    case 55: return ",";
                    case 56: return "?";
                    case 57: return ":";
                    case 58: return "===";
                    ...
                    case 61: return "!==";
                    case 62: return "!=";
                    case 63: return parser.restricted = !1, "!";
                    case 64: return "<<=";
                    case 65: return "<<";
                    case 66: return "<=";
                    case 67: return "<";
                    ...
                    case 73: return ">";
                    case 74: return "+=";
                    case 75: return parser.restricted = !1, "++";
                    case 76: return "+";
                    case 77: return "-=";
                    case 78: return parser.restricted = !1, "--";
                    case 79: return "-";
                    case 80: return "*=";
                    case 81: return "*";
                    case 82: return "/=";
                    ...
                    case 92: return "^=";
                    case 93: return "^";
                    case 94: return parser.restricted = !1, "~";
                    case 95: return "EOF";
    ...
    var GPUUtils = function () { function systemEndianness() { if (null !== endianness)
        return endianness; var b = new ArrayBuffer(4), a = new Uint32Array(b), c = new Uint8Array(b); if (a[0] = 3735928559, 239 == c[0])
        return endianness = "LE"; if (222 == c[0])
        return endianness = "BE"; throw new Error("unknown endianness"); } function isFunction(funcObj) { return "function" == typeof funcObj; } function isFunctionString(funcStr) { return null !== funcStr ? "function" == funcStr.toString().slice(0, "function".length).toLowerCase() : !1; } function getFunctionName_fromString(funcStr) { return FUNCTION_NAME.exec(funcStr)[1]; } function getParamNames_fromString(func) { var fnStr = func.toString().replace(STRIP_COMMENTS, ""), result = fnStr.slice(fnStr.indexOf("(") + 1, fnStr.indexOf(")")).match(ARGUMENT_NAMES); return null === result && (result = []), result; } function clone(obj) { if (null === obj || "object" != typeof obj || "isActiveClone" in obj)
        return obj; var temp = obj.constructor(); for (var key in obj)
        Object.prototype.hasOwnProperty.call(obj, key) && (obj.isActiveClone = null, temp[key] = clone(obj[key]), delete obj.isActiveClone); return temp; } var GPUUtils = {}, endianness = null; GPUUtils.systemEndianness = systemEndianness, GPUUtils.isFunction = isFunction, GPUUtils.isFunctionString = isFunctionString; var FUNCTION_NAME = /function ([^(]*)/; GPUUtils.getFunctionName_fromString = getFunctionName_fromString; var STRIP_COMMENTS = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, ARGUMENT_NAMES = /([^\s,]+)/g; return GPUUtils.getParamNames_fromString = getParamNames_fromString, GPUUtils.clone = clone, GPUUtils; }(), GPUTexture = function () { function GPUTexture(gpu, texture, size, dimensions) { this.gpu = gpu, this.texture = texture, this.size = size, this.dimensions = dimensions; } return GPUTexture.prototype.toArray = function () { return this.gpu.textureToArray(this); }, GPUTexture; }(), GPU = function () { function GPU(ctx) { var gl, canvas, canvasCpu; if (canvas = void 0, gl = ctx, void 0 === gl) {
        canvasCpu = document.createElement("canvas"), canvas = document.createElement("canvas"), canvas.width = 2, canvas.height = 2;
        var glOpt = { depth: !1, antialias: !1 };
        gl = canvas.getContext("experimental-webgl", glOpt) || canvas.getContext("webgl", glOpt);
    } this.OES_texture_float = gl.getExtension("OES_texture_float"), this.OES_texture_float_linear = gl.getExtension("OES_texture_float_linear"), this.OES_texture_index_uint = gl.getExtension("OES_element_index_uint"), this.gl = gl, this.canvas = canvas, this.canvasCpu = canvasCpu, this.programCache = {}, this.endianness = GPUUtils.systemEndianness(), this.functionBuilder = new functionBuilder(this), this.functionBuilder.polyfillStandardFunctions(); } function createKernel(kernel, paramObj) { if (void 0 === kernel)
        throw "Missing kernel parameter"; if (!(kernel instanceof Function))
        throw "kernel parameter not a function"; void 0 === paramObj && (paramObj = {}), paramObj.dimensions = paramObj.dimensions || []; var mode = paramObj.mode && paramObj.mode.toLowerCase(); if ("cpu" == mode)
        return this._mode_cpu(kernel, paramObj); try {
        return this._mode_gpu(kernel, paramObj);
    }
    catch (e) {
        if ("gpu" != mode)
            return console.warning("Falling back to CPU!"), this._mode_cpu(kernel, paramObj);
        throw e;
    } } function addFunction(jsFunction, paramTypeArray, returnType) { return this.functionBuilder.addFunction(null, jsFunction, paramTypeArray, returnType), this; } return GPU.prototype.getGl = function () { return this.gl; }, GPU.prototype.getCanvas = function (mode) { return "cpu" == mode ? this.canvasCpu : this.canvas; }, GPU.prototype.createKernel = createKernel, GPU.prototype.addFunction = addFunction, GPU.prototype.textureToArray = function (texture) { var copy = this.createKernel(function (x) { return x[this.thread.z][this.thread.y][this.thread.x]; }); return copy(texture); }, GPU; }(), functionNode_webgl = function () { function isIdentifierConstant(paramName) { return -1 != opt.constants.indexOf(paramName); } function functionNode_webgl(inNode, _opt) { return gpu = inNode.gpu, opt = _opt, jsFunctionString = inNode.jsFunctionString, inNode.webglFunctionString_array = ast_generic(inNode.getJS_AST(), [], inNode), inNode.webglFunctionString = webgl_regex_optimize(inNode.webglFunctionString_array.join("").trim()), inNode.webglFunctionString; } function webgl_regex_optimize(inStr) { return inStr.replace(DECODE32_ENCODE32, "((").replace(ENCODE32_DECODE32, "(("); } function ast_errorOutput(error, ast, funcParam) { return console.error(error, ast, funcParam), error; } function ast_generic(ast, retArr, funcParam) { if (null === ast)
        throw ast_errorOutput("NULL ast", ast, funcParam); if (Array.isArray(ast)) {
        for (var i = 0; i < ast.length; i++)
            ast_generic(ast[i], retArr, funcParam);
        return retArr;
    } switch (ast.type) {
        case "FunctionDeclaration": return ast_FunctionDeclaration(ast, retArr, funcParam);
        case "FunctionExpression": return ast_FunctionExpression(ast, retArr, funcParam);
        case "ReturnStatement": return ast_ReturnStatement(ast, retArr, funcParam);
        case "Literal": return ast_Literal(ast, retArr, funcParam);
        case "BinaryExpression": return ast_BinaryExpression(ast, retArr, funcParam);
        case "Identifier": return ast_IdentifierExpression(ast, retArr, funcParam);
        case "AssignmentExpression": return ast_AssignmentExpression(ast, retArr, funcParam);
        case "ExpressionStatement": return ast_ExpressionStatement(ast, retArr, funcParam);
        case "EmptyStatement": return ast_EmptyStatement(ast, retArr, funcParam);
        case "BlockStatement": return ast_BlockStatement(ast, retArr, funcParam);
        case "IfStatement": return ast_IfStatement(ast, retArr, funcParam);
        case "BreakStatement": return ast_BreakStatement(ast, retArr, funcParam);
        case "ContinueStatement": return ast_ContinueStatement(ast, retArr, funcParam);
        case "ForStatement": return ast_ForStatement(ast, retArr, funcParam);
        case "WhileStatement": return ast_WhileStatement(ast, retArr, funcParam);
        case "VariableDeclaration": return ast_VariableDeclaration(ast, retArr, funcParam);
        case "VariableDeclarator": return ast_VariableDeclarator(ast, retArr, funcParam);
        case "ThisExpression": return ast_ThisExpression(ast, retArr, funcParam);
        case "SequenceExpression": return ast_SequenceExpression(ast, retArr, funcParam);
        case "UnaryExpression": return ast_UnaryExpression(ast, retArr, funcParam);
        case "UpdateExpression": return ast_UpdateExpression(ast, retArr, funcParam);
        case "LogicalExpression": return ast_LogicalExpression(ast, retArr, funcParam);
        case "MemberExpression": return ast_MemberExpression(ast, retArr, funcParam);
        case "CallExpression": return ast_CallExpression(ast, retArr, funcParam);
    } throw ast_errorOutput("Unknown ast type : " + ast.type, ast, funcParam); } function ast_FunctionDeclaration(ast, retArr, funcParam) { var lines = jsFunctionString.split(/\r?\n/), start = ast.loc.start, end = ast.loc.end, funcArr = []; funcArr.push(lines[start.line - 1].slice(start.column)); for (var i = start.line; i < end.line - 1; i++)
        funcArr.push(lines[i]); funcArr.push(lines[end.line - 1].slice(0, end.column)); var funcStr = funcArr.join("\n"); return gpu.addFunction(funcStr), retArr; } function ast_FunctionExpression(ast, retArr, funcParam) { if (funcParam.isRootKernel ? retArr.push("void") : retArr.push(funcParam.returnType), retArr.push(" "), retArr.push(funcParam.functionName), retArr.push("("), !funcParam.isRootKernel)
        for (var i = 0; i < funcParam.paramNames.length; ++i)
            i > 0 && retArr.push(", "), retArr.push(funcParam.paramType[i]), retArr.push(" "), retArr.push("user_"), retArr.push(funcParam.paramNames[i]); retArr.push(") {\n"); for (var i = 0; i < ast.body.length; ++i)
        ast_generic(ast.body[i], retArr, funcParam), retArr.push("\n"); return retArr.push("}\n"), retArr; } function ast_ReturnStatement(ast, retArr, funcParam) { return funcParam.isRootKernel ? (retArr.push("kernelResult = "), ast_generic(ast.argument, retArr, funcParam), retArr.push(";"), retArr.push("return;")) : (retArr.push("return "), ast_generic(ast.argument, retArr, funcParam), retArr.push(";")), retArr; } function ast_Literal(ast, retArr, funcParam) { if (isNaN(ast.value))
        throw ast_errorOutput("Non-numeric literal not supported : " + ast.value, ast, funcParam); return retArr.push(ast.value), Number.isInteger(ast.value) && retArr.push(".0"), retArr; } function ast_BinaryExpression(ast, retArr, funcParam) { return "%" == ast.operator ? (retArr.push("mod("), ast_generic(ast.left, retArr, funcParam), retArr.push(","), ast_generic(ast.right, retArr, funcParam), retArr.push(")")) : (ast_generic(ast.left, retArr, funcParam), retArr.push(ast.operator), ast_generic(ast.right, retArr, funcParam)), retArr; } function ast_IdentifierExpression(idtNode, retArr, funcParam) { if ("Identifier" != idtNode.type)
        throw ast_errorOutput("IdentifierExpression - not an Identifier", ast, funcParam); return "gpu_threadX" == idtNode.name ? retArr.push("threadId.x") : "gpu_threadY" == idtNode.name ? retArr.push("threadId.y") : "gpu_threadZ" == idtNode.name ? retArr.push("threadId.z") : "gpu_dimensionsX" == idtNode.name ? retArr.push("uOutputDim.x") : "gpu_dimensionsY" == idtNode.name ? retArr.push("uOutputDim.y") : "gpu_dimensionsZ" == idtNode.name ? retArr.push("uOutputDim.z") : retArr.push("user_" + idtNode.name), retArr; } function ast_ForStatement(forNode, retArr, funcParam) { if ("ForStatement" != forNode.type)
        throw ast_errorOutput("Invalid for statment", ast, funcParam); if (forNode.test && "BinaryExpression" == forNode.test.type) {
        if ("Identifier" == forNode.test.right.type && "<" == forNode.test.operator && 0 == isIdentifierConstant(forNode.test.right.name)) {
            void 0 === opt.loopMaxIterations && (console.warn("Warning: loopMaxIterations is not set! Using default of 100 which may result in unintended behavior."), console.warn("Set loopMaxIterations or use a for loop of fixed length to silence this message.")), retArr.push("for (float "), ast_generic(forNode.init, retArr, funcParam), retArr.push(";"), ast_generic(forNode.test.left, retArr, funcParam), retArr.push(forNode.test.operator), retArr.push("LOOP_MAX"), retArr.push(";"), ast_generic(forNode.update, retArr, funcParam), retArr.push(")"), retArr.push("{\n"), retArr.push("if ("), ast_generic(forNode.test.left, retArr, funcParam), retArr.push(forNode.test.operator), ast_generic(forNode.test.right, retArr, funcParam), retArr.push(") {\n");
            for (var i = 0; i < forNode.body.body.length; i++)
                ast_generic(forNode.body.body[i], retArr, funcParam);
            return retArr.push("} else {\n"), retArr.push("break;\n"), retArr.push("}\n"), retArr.push("}\n"), retArr;
        }
        return retArr.push("for (float "), ast_generic(forNode.init, retArr, funcParam), retArr.push(";"), ast_generic(forNode.test, retArr, funcParam), retArr.push(";"), ast_generic(forNode.update, retArr, funcParam), retArr.push(")"), ast_generic(forNode.body, retArr, funcParam), retArr;
    } throw ast_errorOutput("Invalid for statment", ast, funcParam); } function ast_WhileStatement(whileNode, retArr, funcParam) { if ("WhileStatement" != whileNode.type)
        throw ast_errorOutput("Invalid while statment", ast, funcParam); return retArr.push("for (float i=0.0; i<LOOP_MAX; i++) {"), retArr.push("if ("), ast_generic(whileNode.test, retArr, funcParam), retArr.push(") {\n"), ast_generic(whileNode.body, retArr, funcParam), retArr.push("} else {\n"), retArr.push("break;\n"), retArr.push("}\n"), retArr.push("}\n"), retArr; } function ast_AssignmentExpression(assNode, retArr, funcParam) { return "%=" != assNode.operator ? (ast_generic(assNode.left, retArr, funcParam), retArr.push(assNode.operator), ast_generic(assNode.right, retArr, funcParam), retArr) : (ast_generic(assNode.left, retArr, funcParam), retArr.push("="), retArr.push("mod("), ast_generic(assNode.left, retArr, funcParam), retArr.push(","), ast_generic(assNode.right, retArr, funcParam), retArr.push(")"), void 0); } function ast_EmptyStatement(eNode, retArr, funcParam) { return retArr.push(";\n"), retArr; } function ast_BlockStatement(bNode, retArr, funcParam) { retArr.push("{\n"); for (var i = 0; i < bNode.body.length; i++)
        ast_generic(bNode.body[i], retArr, funcParam); return retArr.push("}\n"), retArr; } function ast_ExpressionStatement(esNode, retArr, funcParam) { return ast_generic(esNode.expression, retArr, funcParam), retArr.push(";\n"), retArr; } function ast_VariableDeclaration(vardecNode, retArr, funcParam) { retArr.push("float "); for (var i = 0; i < vardecNode.declarations.length; i++)
        i > 0 && retArr.push(","), ast_generic(vardecNode.declarations[i], retArr, funcParam); return retArr.push(";"), retArr; } function ast_VariableDeclarator(ivardecNode, retArr, funcParam) { return ast_generic(ivardecNode.id, retArr, funcParam), null !== ivardecNode.init && (retArr.push("="), ast_generic(ivardecNode.init, retArr, funcParam)), retArr; } function ast_IfStatement(ifNode, retArr, funcParam) { return retArr.push("if("), ast_generic(ifNode.test, retArr, funcParam), retArr.push(")"), ast_generic(ifNode.consequent, retArr, funcParam), ifNode.alternate && (retArr.push("else "), ast_generic(ifNode.alternate, retArr, funcParam)), retArr; } function ast_LogicalExpression(logNode, retArr, funcParam) { return ast_generic(logNode.left, retArr, funcParam), retArr.push(logNode.operator), ast_generic(logNode.right, retArr, funcParam), retArr; } function ast_UpdateExpression(uNode, retArr, funcParam) { return uNode.prefix ? (retArr.push(uNode.operator), ast_generic(uNode.argument, retArr, funcParam)) : (ast_generic(uNode.argument, retArr, funcParam), retArr.push(uNode.operator)), retArr; } function ast_UnaryExpression(uNode, retArr, funcParam) { return uNode.prefix ? (retArr.push(uNode.operator), ast_generic(uNode.argument, retArr, funcParam)) : (ast_generic(uNode.argument, retArr, funcParam), retArr.push(uNode.operator)), retArr; } function ast_ThisExpression(tNode, retArr, funcParam) { return retArr.push("this"), retArr; } function ast_MemberExpression(mNode, retArr, funcParam) { if (mNode.computed) {
        if ("Identifier" == mNode.object.type)
            retArr.push("get("), ast_generic(mNode.object, retArr, funcParam), retArr.push(", vec2("), ast_generic(mNode.object, retArr, funcParam), retArr.push("Size[0],"), ast_generic(mNode.object, retArr, funcParam), retArr.push("Size[1]), vec3("), ast_generic(mNode.object, retArr, funcParam), retArr.push("Dim[0],"), ast_generic(mNode.object, retArr, funcParam), retArr.push("Dim[1],"), ast_generic(mNode.object, retArr, funcParam), retArr.push("Dim[2]"), retArr.push("), ");
        else {
            ast_generic(mNode.object, retArr, funcParam);
            retArr.pop();
            retArr.push(",");
        }
        ast_generic(mNode.property, retArr, funcParam), retArr.push(")");
    }
    else {
        var unrolled = ast_MemberExpression_unroll(mNode), unrolled_lc = unrolled.toLowerCase();
        0 === unrolled.indexOf(constantsPrefix) && (unrolled = "constants_" + unrolled.slice(constantsPrefix.length)), "this.thread.x" == unrolled_lc ? retArr.push("threadId.x") : "this.thread.y" == unrolled_lc ? retArr.push("threadId.y") : "this.thread.z" == unrolled_lc ? retArr.push("threadId.z") : "this.dimensions.x" == unrolled_lc ? retArr.push("uOutputDim.x") : "this.dimensions.y" == unrolled_lc ? retArr.push("uOutputDim.y") : "this.dimensions.z" == unrolled_lc ? retArr.push("uOutputDim.z") : retArr.push(unrolled);
    } return retArr; } function ast_SequenceExpression(sNode, retArr, funcParam) { for (var i = 0; i < sNode.expressions.length; i++)
        i > 0 && retArr.push(","), ast_generic(sNode.expressions, retArr, funcParam); return retArr; } function ast_MemberExpression_unroll(ast, funcParam) { if ("Identifier" == ast.type)
        return ast.name; if ("ThisExpression" == ast.type)
        return "this"; if ("MemberExpression" == ast.type && ast.object && ast.property)
        return ast_MemberExpression_unroll(ast.object, funcParam) + "." + ast_MemberExpression_unroll(ast.property, funcParam); throw ast_errorOutput("Unknown CallExpression_unroll", ast, funcParam); } function ast_CallExpression(ast, retArr, funcParam) { if (ast.callee) {
        var funcName = ast_MemberExpression_unroll(ast.callee);
        0 === funcName.indexOf(jsMathPrefix) && (funcName = funcName.slice(jsMathPrefix.length)), 0 === funcName.indexOf(localPrefix) && (funcName = funcName.slice(localPrefix.length)), funcParam.calledFunctions.indexOf(funcName) < 0 && funcParam.calledFunctions.push(funcName), retArr.push(funcName), retArr.push("(");
        for (var i = 0; i < ast.arguments.length; ++i)
            i > 0 && retArr.push(", "), ast_generic(ast.arguments[i], retArr, funcParam);
        return retArr.push(")"), retArr;
    } throw ast_errorOutput("Unknown CallExpression", ast, funcParam); } var gpu, opt, jsFunctionString, DECODE32_ENCODE32 = /decode32\(\s+encode32\(/g, ENCODE32_DECODE32 = /encode32\(\s+decode32\(/g, jsMathPrefix = "Math.", localPrefix = "this.", constantsPrefix = "this.constants."; return functionNode_webgl; }(), functionNode = function () { function functionNode(gpu, functionName, jsFunction, paramTypeArray, returnType) { if (this.gpu = gpu, this.calledFunctions = [], this.initVariables = [], this.readVariables = [], this.writeVariables = [], null == jsFunction)
        throw "jsFunction, parameter is null"; if (this.jsFunctionString = jsFunction.toString(), !GPUUtils.isFunctionString(this.jsFunctionString))
        throw console.error("jsFunction, to string conversion check falied: not a function?", this.jsFunctionString), "jsFunction, to string conversion check falied: not a function?"; if (GPUUtils.isFunction(jsFunction) ? this.jsFunction = jsFunction : this.jsFunction = null, this.functionName = functionName || jsFunction && jsFunction.name || GPUUtils.getFunctionName_fromString(this.jsFunctionString), !this.functionName)
        throw "jsFunction, missing name argument or value"; if (this.paramNames = GPUUtils.getParamNames_fromString(this.jsFunctionString), null != paramTypeArray) {
    ...
    } this.returnType = returnType || "float"; } function getJSFunction() { if (this.jsFunction)
        return this.jsFunction; if (this.jsFunctionString)
        return this.jsFunction = eval(this.jsFunctionString), this.jsFunction; throw "Missin jsFunction, and jsFunctionString parameter"; } function getJS_AST(inParser) { if (this.jsFunctionAST)
        return this.jsFunctionAST; if (inParser = inParser || parser, null == inParser)
        throw "Missing JS to AST parser"; var prasedObj = parser.parse("var " + this.functionName + " = " + this.jsFunctionString + ";"); if (null === prasedObj)
        throw "Failed to parse JS code via JISON"; var funcAST = prasedObj.body[0].declarations[0].init; return this.jsFunctionAST = funcAST, funcAST; } function getWebglFunctionString(opt) { return this.webglFunctionString ? this.webglFunctionString : this.webglFunctionString = functionNode_webgl(this, opt); } function setWebglFunctionString(shaderCode) { this.webglFunctionString = shaderCode; } return functionNode.prototype.getJSFunction = getJSFunction, functionNode.prototype.getJS_AST = getJS_AST, functionNode.prototype.getWebglFunctionString = getWebglFunctionString, functionNode.prototype.setWebglFunctionString = setWebglFunctionString, functionNode; }(), functionBuilder = function () { function functionBuilder(gpu) { this.nodeMap = {}, this.gpu = gpu; } function addFunction(functionName, jsFunction, paramTypeArray, returnType) { this.addFunctionNode(new functionNode(this.gpu, functionName, jsFunction, paramTypeArray, returnType)); } function addFunctionNode(inNode) { this.nodeMap[inNode.functionName] = inNode; } function traceFunctionCalls(functionName, retList, opt) { functionName = functionName || "kernel", retList = retList || []; var fNode = this.nodeMap[functionName]; if (fNode)
        if (retList.indexOf(functionName) >= 0)
            ;
        else {
            retList.push(functionName), fNode.getWebglFunctionString(opt);
            for (var i = 0; i < fNode.calledFunctions.length; ++i)
                this.traceFunctionCalls(fNode.calledFunctions[i], retList, opt);
        } return retList; } function webglString_fromFunctionNames(functionList, opt) { for (var ret = [], i = 0; i < functionList.length; ++i) {
        var node = this.nodeMap[functionList[i]];
        node && ret.push(this.nodeMap[functionList[i]].getWebglFunctionString(opt));
    } return ret.join("\n"); } function webglString(functionName, opt) { return void 0 == opt && (opt = {}), functionName ? this.webglString_fromFunctionNames(this.traceFunctionCalls(functionName, [], opt).reverse(), opt) : this.webglString_fromFunctionNames(Object.keys(this.nodeMap), opt); } function round(a) { return Math.floor(a + .5); } function polyfillStandardFunctions() { this.addFunction(null, round); } return functionBuilder.prototype.addFunction = addFunction, functionBuilder.prototype.addFunctionNode = addFunctionNode, functionBuilder.prototype.traceFunctionCalls = traceFunctionCalls, functionBuilder.prototype.webglString_fromFunctionNames = webglString_fromFunctionNames, functionBuilder.prototype.webglString = webglString, functionBuilder.prototype.polyfillStandardFunctions = polyfillStandardFunctions, functionBuilder; }();
    return function (GPU) { function getArgumentType(arg) { return Array.isArray(arg) ? "Array" : "number" == typeof arg ? "Number" : arg instanceof GPUTexture ? "Texture" : "Unknown"; } GPU.prototype._mode_cpu = function (kernel, opt) { function ret() { if (!opt.dimensions || 0 === opt.dimensions.length) {
    ...
    } for (var kernelArgs = [], i = 0; i < arguments.length; i++) {
        var argType = getArgumentType(arguments[i]);
        if ("Array" == argType || "Number" == argType)
    ...
    } for (var threadDim = GPUUtils.clone(opt.dimensions); threadDim.length < 3;)
        threadDim.push(1); for (var ret = new Array(threadDim[2]), i = 0; i < threadDim[2]; i++) {
        ret[i] = new Array(threadDim[1]);
        for (var j = 0; j < threadDim[1]; j++)
            ret[i][j] = new Array(threadDim[0]);
    } var canvas, canvasCtx, imageData, data, ctx = { thread: { x: 0, y: 0, z: 0 }, dimensions: { x: threadDim[0], y: threadDim[1], z: threadDim[2] }, constants: opt.constants }; for (opt.graphical && (canvas = gpu.getCanvas("cpu"), canvas.width = threadDim[0], canvas.height = threadDim[1], canvasCtx = canvas.getContext("2d"), imageData = canvasCtx.createImageData(threadDim[0], threadDim[1]), data = new Uint8ClampedArray(threadDim[0] * threadDim[1] * 4), ctx.color = function (r, g, b, a) { void 0 == a && (a = 1), r = Math.floor(255 * r), g = Math.floor(255 * g), b = Math.floor(255 * b), a = Math.floor(255 * a); var width = ctx.dimensions.x, height = ctx.dimensions.y, x = ctx.thread.x, y = height - ctx.thread.y - 1, index = x + y * width; data[4 * index + 0] = r, data[4 * index + 1] = g, data[4 * index + 2] = b, data[4 * index + 3] = a; }), ctx.thread.z = 0; ctx.thread.z < threadDim[2]; ctx.thread.z++)
        for (ctx.thread.y = 0; ctx.thread.y < threadDim[1]; ctx.thread.y++)
            for (ctx.thread.x = 0; ctx.thread.x < threadDim[0]; ctx.thread.x++)
                ret[ctx.thread.z][ctx.thread.y][ctx.thread.x] = kernel.apply(ctx, kernelArgs); return opt.graphical && (imageData.data.set(data), canvasCtx.putImageData(imageData, 0, 0)), 1 == opt.dimensions.length ? ret = ret[0][0] : 2 == opt.dimensions.length && (ret = ret[0]), ret; } var gpu = this; return ret.dimensions = function (dim) { return opt.dimensions = dim, ret; }, ret.debug = function (flag) { return opt.debug = flag, ret; }, ret.graphical = function (flag) { return opt.graphical = flag, ret; }, ret.loopMaxIterations = function (max) { return opt.loopMaxIterations = max, ret; }, ret.constants = function (constants) { return opt.constants = constants, ret; }, ret.wraparound = function (flag) { return console.warn("Wraparound mode is not supported and undocumented."), opt.wraparound = flag, ret; }, ret.hardcodeConstants = function (flag) { return opt.hardcodeConstants = flag, ret; }, ret.outputToTexture = function (flag) { return opt.outputToTexture = flag, ret; }, ret.floatTextures = function (flag) { return opt.floatTextures = flag, ret; }, ret.mode = function (mode) { return opt.mode = mode, gpu.createKernel(kernel, opt); }, ret.getCanvas = function () { return gpu.getCanvas("cpu"); }, ret; }; }(GPU), function (GPU) {
        function dimToTexSize(opt, dimensions, output) { for (var numTexels = dimensions[0], i = 1; i < dimensions.length; i++)
            numTexels *= dimensions[i]; opt.floatTextures && !output && (numTexels = Math.ceil(numTexels / 4)); var w = Math.ceil(Math.sqrt(numTexels)); return [w, w]; }
        function validateStringIsFunction(funcStr) { return null !== funcStr ? "function" == funcStr.slice(0, "function".length).toLowerCase() : !1; }
        function getDimensions(x, pad) { var ret; if (Array.isArray(x)) {
            for (var dim = [], temp = x; Array.isArray(temp);)
                dim.push(temp.length), temp = temp[0];
            ret = dim.reverse();
        }
        else {
            if (!(x instanceof GPUTexture))
                throw "Unknown dimensions of " + x;
            ret = x.dimensions;
        } if (pad)
            for (ret = GPUUtils.clone(ret); ret.length < 3;)
                ret.push(1); return ret; }
        function flatten(arr, padding) { return Array.isArray(arr[0]) ? [].concat.apply([], arr) : arr; }
        function splitArray(array, part) { for (var tmp = [], i = 0; i < array.length; i += part)
            tmp.push(array.slice(i, i + part)); return tmp; }
        function getArgumentType(arg) { return Array.isArray(arg) ? "Array" : "number" == typeof arg ? "Number" : arg instanceof GPUTexture ? "Texture" : "Unknown"; }
        function getProgramCacheKey(args, opt, outputDim) { for (var key = "", i = 0; i < args.length; i++) {
            var argType = getArgumentType(args[i]);
            if (key += argType, opt.hardcodeConstants) {
                var dimensions;
                "Array" != argType && "Texture" != argType || (dimensions = getDimensions(args[i], !0), key += "[" + dimensions[0] + "," + dimensions[1] + "," + dimensions[2] + "]");
            }
        } var specialFlags = ""; return opt.wraparound && (specialFlags += "Wraparound"), opt.hardcodeConstants && (specialFlags += "Hardcode", specialFlags += "[" + outputDim[0] + "," + outputDim[1] + "," + outputDim[2] + "]"), opt.constants && (specialFlags += "Constants", specialFlags += JSON.stringify(opt.constants)), specialFlags && (key = key + "-" + specialFlags), key; }
        GPU.prototype._mode_gpu = function (kernel, opt) {
            function ret() {
                ...
                if (!opt.dimensions || 0 === opt.dimensions.length) {
                    if (1 != arguments.length)
                        throw "Auto dimensions only supported for kernels with only one input";
                    var argType = getArgumentType(arguments[0]);
                    if ("Array" == argType)
                ...
                var texSize = dimToTexSize(gpu, opt.dimensions, !0);
                if (opt.graphical) {
                    if (2 != opt.dimensions.length)
                        throw "Output must have 2 dimensions on graphical mode";
                    texSize = GPUUtils.clone(opt.dimensions);
                }
                canvas.width = texSize[0], canvas.height = texSize[1], gl.viewport(0, 0, texSize[0], texSize[1]);
                for (var threadDim = GPUUtils.clone(opt.dimensions); threadDim.length < 3;)
                    threadDim.push(1);
                var programCacheKey = getProgramCacheKey(arguments, opt, opt.dimensions), program = programCache[programCacheKey];
                if (void 0 === program) {
                    var constantsStr = "";
                    if (opt.constants)
                    ...
                    for (var paramStr = "", paramType = [], i = 0; i < paramNames.length; i++) {
                        var argType = getArgumentType(arguments[i]);
                        if (paramType.push(argType), opt.hardcodeConstants)
                            if ("Array" == argType || "Texture" == argType) {
                                var paramDim = getDimensions(arguments[i], !0), paramSize = dimToTexSize(gpu, paramDim);
                                ...
                                "Number" == argType && Number.isInteger(arguments[i]) ? paramStr += "highp float user_" + paramNames[i] + " = " + arguments[i] + ".0;\n" : "Number" == argType && (paramStr += "highp float user_" + paramNames[i] + " = " + arguments[i] + ";\n");
                        else
                            "Array" == argType || "Texture" == argType ? (paramStr += "uniform highp sampler2D user_" + paramNames[i] + ";\n", paramStr += "uniform highp vec2 user_" + paramNames[i] + "Size;\n", paramStr += "uniform highp vec3 user_" + paramNames[i] + "Dim;\n") : "Number" == argType && (paramStr += "uniform highp float user_" + paramNames[i] + ";\n");
                    }
                    var kernelNode = new functionNode(gpu, "kernel", kernel);
                    kernelNode.paramNames = paramNames, kernelNode.paramType = paramType, kernelNode.isRootKernel = !0, builder.addFunctionNode(kernelNode);
                    ...
                    if (gl.shaderSource(vertShader, vertShaderSrc), gl.shaderSource(fragShader, fragShaderSrc), gl.compileShader(vertShader), gl.compileShader(fragShader), !gl.getShaderParameter(vertShader, gl.COMPILE_STATUS))
                        throw console.error("An error occurred compiling the shaders: " + gl.getShaderInfoLog(vertShader)), console.log(vertShaderSrc), "Error compiling vertex shader";
                    if (!gl.getShaderParameter(fragShader, gl.COMPILE_STATUS))
                        throw console.error("An error occurred compiling the shaders: " + gl.getShaderInfoLog(fragShader)), console.log(fragShaderSrc), "Error compiling fragment shader";
                    opt.debug && console.log(fragShaderSrc), program = gl.createProgram(), gl.attachShader(program, vertShader), gl.attachShader(program, fragShader), gl.linkProgram(program), programCache[programCacheKey] = program;
                }
                gl.useProgram(program);
                var vertices = new Float32Array([-1, -1, 1, -1, -1, 1, 1, 1]), texCoords = new Float32Array([0, 0, 1, 0, 0, 1, 1, 1]), texCoordOffset = vertices.byteLength, buffer = gl.createBuffer();
                gl.bindBuffer(gl.ARRAY_BUFFER, buffer), gl.bufferData(gl.ARRAY_BUFFER, vertices.byteLength + texCoords.byteLength, gl.STATIC_DRAW), gl.bufferSubData(gl.ARRAY_BUFFER, 0, vertices), gl.bufferSubData(gl.ARRAY_BUFFER, texCoordOffset, texCoords);
                var aPosLoc = gl.getAttribLocation(program, "aPos");
                gl.enableVertexAttribArray(aPosLoc), gl.vertexAttribPointer(aPosLoc, 2, gl.FLOAT, gl.FALSE, 0, 0);
                var aTexCoordLoc = gl.getAttribLocation(program, "aTexCoord");
                if (gl.enableVertexAttribArray(aTexCoordLoc), gl.vertexAttribPointer(aTexCoordLoc, 2, gl.FLOAT, gl.FALSE, 0, texCoordOffset), !opt.hardcodeConstants) {
                ...
                for (textureCount = 0; textureCount < paramNames.length; textureCount++) {
                    ...
                    if (Array.isArray(arguments[textureCount])) {
                        paramDim = getDimensions(arguments[textureCount], !0), paramSize = dimToTexSize(gpu, paramDim), texture = gl.createTexture(), gl.activeTexture(gl["TEXTURE" + textureCount]), gl.bindTexture(gl.TEXTURE_2D, texture), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
                        var paramArray = flatten(arguments[textureCount]), paramLength = paramSize[0] * paramSize[1];
                        for (opt.floatTextures && (paramLength *= 4); paramArray.length < paramLength;)
                            paramArray.push(0);
                        var argBuffer;
                        opt.floatTextures ? (argBuffer = new Float32Array(paramArray), gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, paramSize[0], paramSize[1], 0, gl.RGBA, gl.FLOAT, argBuffer)) : (argBuffer = new Uint8Array(new Float32Array(paramArray).buffer), gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, paramSize[0], paramSize[1], 0, gl.RGBA, gl.UNSIGNED_BYTE, argBuffer)), textures[textureCount] = texture;
                        var paramLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount]), paramSizeLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount] + "Size"), paramDimLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount] + "Dim");
                        opt.hardcodeConstants || (gl.uniform3fv(paramDimLoc, paramDim), gl.uniform2fv(paramSizeLoc, paramSize)), gl.uniform1i(paramLoc, textureCount);
                    }
                    else if ("number" == typeof arguments[textureCount]) {
                        var argLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount]);
                        gl.uniform1f(argLoc, arguments[textureCount]);
                    }
                    else {
                        if (!(arguments[textureCount] instanceof GPUTexture))
                            throw "Input type not supported: " + arguments[textureCount];
                        paramDim = getDimensions(arguments[textureCount]), paramSize = arguments[textureCount].size, texture = arguments[textureCount].texture, textures[textureCount] = texture, gl.activeTexture(gl["TEXTURE" + textureCount]), gl.bindTexture(gl.TEXTURE_2D, texture);
                        var paramLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount]), paramSizeLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount] + "Size"), paramDimLoc = gl.getUniformLocation(program, "user_" + paramNames[textureCount] + "Dim");
                        gl.uniform3fv(paramDimLoc, paramDim), gl.uniform2fv(paramSizeLoc, paramSize), gl.uniform1i(paramLoc, textureCount);
                    }
                }
                if (opt.outputToTexture) {
                    var outputTexture = gl.createTexture();
                    gl.activeTexture(gl["TEXTURE" + textureCount]), gl.bindTexture(gl.TEXTURE_2D, outputTexture), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST), gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST), gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, texSize[0], texSize[1], 0, gl.RGBA, gl.UNSIGNED_BYTE, null);
                    var framebuffer = gl.createFramebuffer();
                    return framebuffer.width = texSize[0], framebuffer.height = texSize[1], gl.bindFramebuffer(gl.FRAMEBUFFER, framebuffer), gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, outputTexture, 0), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4), new GPUTexture(gpu, outputTexture, texSize, opt.dimensions);
                }
                if (gl.bindRenderbuffer(gl.RENDERBUFFER, null), gl.bindFramebuffer(gl.FRAMEBUFFER, null), gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4), !opt.graphical) {
                    var bytes = new Uint8Array(texSize[0] * texSize[1] * 4);
                    gl.readPixels(0, 0, texSize[0], texSize[1], gl.RGBA, gl.UNSIGNED_BYTE, bytes);
                    var result = Array.prototype.slice.call(new Float32Array(bytes.buffer));
                    if (result.length = threadDim[0] * threadDim[1] * threadDim[2], 1 == opt.dimensions.length)
                        return result;
                    if (2 == opt.dimensions.length)
                        return splitArray(result, opt.dimensions[0]);
                    if (3 == opt.dimensions.length) {
                        var cube = splitArray(result, opt.dimensions[0] * opt.dimensions[1]);
                        return cube.map(function (x) { return splitArray(x, opt.dimensions[0]); });
                    }
                }
            }
            var gpu = this, gl = this.gl, canvas = this.canvas, builder = this.functionBuilder, endianness = this.endianness, funcStr = kernel.toString();
            if (!validateStringIsFunction(funcStr))
                throw "Unable to get body of kernel function";
            var paramNames = GPUUtils.getParamNames_fromString(funcStr), programCache = [];
            return ret.dimensions = function (dim) { return opt.dimensions = dim, ret; }, ret.debug = function (flag) { return opt.debug = flag, ret; }, ret.graphical = function (flag) { return opt.graphical = flag, ret; }, ret.loopMaxIterations = function (max) { return opt.loopMaxIterations = max, ret; }, ret.constants = function (constants) { return opt.constants = constants, ret; }, ret.wraparound = function (flag) { return console.warn("Wraparound mode is not supported and undocumented."), opt.wraparound = flag, ret; }, ret.hardcodeConstants = function (flag) { return opt.hardcodeConstants = flag, ret; }, ret.outputToTexture = function (flag) { return opt.outputToTexture = flag, ret; }, ret.floatTextures = function (flag) { return opt.floatTextures = flag, ret; }, ret.mode = function (mode) { return opt.mode = mode, gpu.createKernel(kernel, opt); }, ret.getCanvas = function () { return gpu.getCanvas(); }, ret;
        };
    }(GPU), GPU;
}();
//# sourceMappingURL=gpu.min.js.map