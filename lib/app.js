...
(function (Scene) {
    ...
    var generateRandomSpheres = function (count) {
        var ary = [];
        var minDirection = -0.09, maxDirection = 0.09;
    ...
    var opts = generateRandomSpheres(parseInt(rand(3, 3)))
        .concat(light_opts);
    ...
    var Benchmark = (function () {
        ...
        Benchmark.prototype.startBenchmark = function (mode, callback) {
            ...
            setTimeout(function () {
                ...
                _this.latestResults.actualBenchmarkDuration = timeTaken;
                _this.computeMinMaxAvg();
                _this.saveResults();
                callback();
