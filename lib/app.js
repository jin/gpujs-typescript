...
(function (Entity_1) {
    ...
    var Entity = (function () {
        ...
        Entity.prototype.toNumberArray = function () {
            var array = [
                this.entityType,
                this.x,
                this.y,
...
var renderer = function (gpuKernel, cpuKernel, entities, camera, lights) {
    var fps = {
        startTime: 0,
        frameNumber: 0,
        getFPS: function () {
...
var opts = [sphere_1_opts, sphere_2_opts];
...
var cpuKernel = createKernel(Mode.CPU, entities);
var renderLoop = renderer(gpuKernel, cpuKernel, entities, camera, lights);
