...
function vecNormalize(a) {
    var magnitude = vecMagnitude(a);
    var divideBy = (magnitude === 0) ? Infinity : 1 / magnitude;
...
(function (Scene) {
    ...
    var opts = [sphere_1_opts, sphere_2_opts, cylinder_opts];
    Scene.entities = opts.map(function (opt) {
        var ent = new Entity.Entity(opt);
        return ent.toVector();
    });
})(Scene || (Scene = {}));
var Mode;
...
var renderer = function (gpuKernel, entities, camera, lights) {
    var fps = {
        startTime: 0,
        frameNumber: 0,
        getFPS: function () {
...
var createKernel = function (mode, entities) {
    ...
    var kernel = gpu.createKernel(function (camera, lights, entities) {
...
var gpuKernel = createKernel(Mode.GPU, Scene.entities);
var renderLoop = renderer(gpuKernel, Scene.entities, Scene.camera, Scene.lights);
