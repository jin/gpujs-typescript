...
(function (Scene) {
    ...
    let opts = [sphere_1_opts, sphere_2_opts, cylinder_opts];
...
var createKernel = (mode, scene) => {
    ...
    return gpu.createKernel(function (c, l, e, eyeVector, vpRight, vpUp, canvasHeight, canvasWidth, fovRadians, heightWidthRatio, halfWidth, halfHeight, cameraWidth, cameraHeight, pixelWidth, pixelHeight) {
