...
(function (Benchmark_1) {
    var Benchmark = (function () {
        ...
        Benchmark.prototype.startBenchmark = function (mode, callback) {
            ...
            setTimeout(function () {
                _this.stopBenchmark();
                _this.latestResults.actualBenchmarkDuration =
                    _this.latestResults.frameRenderDurations.reduce(function (a, b) { return a + b; });
        ...
        Benchmark.prototype.displaySpeedup = function (elem) {
            ...
            var avgSpeedup = cpuResults.avgFrameRenderDuration / gpuResults.avgFrameRenderDuration;
