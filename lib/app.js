...
(function (ObjType) {
    ...
    ObjType[ObjType["SPHERE"] = 1] = "SPHERE";
    ObjType[ObjType["CUBOID"] = 2] = "CUBOID";
    ObjType[ObjType["CYLINDER"] = 3] = "CYLINDER";
    ObjType[ObjType["CONE"] = 4] = "CONE";
    ObjType[ObjType["TRIANGLE"] = 5] = "TRIANGLE";
})(ObjType || (ObjType = {}));
var Mode;
(function (Mode) {
    Mode[Mode["GPU"] = 0] = "GPU";
...
var objects = [
    2,
    ObjType.SPHERE, 13, 1.0, 0.0, 0.0, 0.2, 0.7, 0.1, 1.0, 100, 500, 500, 40,
    ObjType.SPHERE, 13, 0.0, 0.0, 1.0, 0.2, 0.7, 0.1, 1.0, 200, 600, 200, 20
];
function change(el) {
    if (mode === Mode.CPU) {
        mode = Mode.GPU;
